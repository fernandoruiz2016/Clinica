import { Component, OnInit, AfterViewInit, ChangeDetectorRef } from '@angular/core'; // IMPORTANTE: Agregamos ChangeDetectorRef
...
export class ReportesComponent implements OnInit, AfterViewInit {
  ...
  // Inyectamos el ChangeDetectorRef que te mencionó Fernando
    ...
    this.citaService.filtrarCitas({}).subscribe({
      next: (citas: any[]) => {
        if (citas && citas.length > 0) {
          ...
          // LA MAGIA DE FERNANDO: Forzamos a Angular a mostrar los números nuevos en las tarjetas
