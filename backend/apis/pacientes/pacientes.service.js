const { obtenerPacientesRepository, obtenerPacientePorIdRepository, crearPacienteRepository, actualizarPacienteRepository, eliminarPacienteRepository } = require("./pacientes.repository")
